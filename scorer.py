...
class Scorer():
    def __init__(self, public_path = './master_key/public_key.csv', 
        ...
        self.df_public_key = pd.read_csv(self.public_path, header=None)
        self.df_private_key = pd.read_csv(self.private_path, header=None)
        
    def calculate_score(self, submission_path, submission_type = 'public'):
        #df_submission = pd.read_csv(submission_path)
        df_submission = pd.read_csv(submission_path, header=None)
